    ...
    eintraege_ausgeben() {
        ...
        this.eintraege.forEach(eintrag => {
            console.log(`Titel: ${eintrag.get("titel")}\n`
                ...
                +  `Datum: ${eintrag.get("datum").toLocaleDateString("de-AT", {
                    year: "numeric",
                    month: "2-digit",
                    day: "2-digit"
                })}\n`
                // +`Timestamp: ${eintrag.get("timestamp").toLocaleString("de-AT", {    
                //     year: "numeric",
                //     month: "long",
                //     day: "numeric",
                //     hour: "numeric",
   ...
   gesamtbilanz_erstellen() {
        ...
        this.eintraege.forEach(function(eintrag) {
            ...
            switch(eintrag.get("typ")) {
                ...
                case "Ausgabe":
                    ...
                    break;
                default:
                    console.log(`Der Typ "${neue_gesamtbilanz.get("typ")}" ist nicht bekannt.`);
                    break;
        }
    });
    ...
    eintrag_hinzufuegen() {
        ...
        while(weiterer_eintrag){
            ...
            weiterer_eintrag = confirm("Weiterer Eintrag?");
        }
